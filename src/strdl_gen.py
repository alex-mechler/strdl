...
def generate_file(struct):
    ...
    """
    html = '';
    html_header = '''<p style="text-align: center;">{FILENAME}</p><hr/>
    <p style="text-align: left;">{FILE_DOC}</p><hr/>'''

    html_function = '''<p/><table style="height: 71px; margin-left: auto; margin-right: auto; width: 100%;" border="1"><tbody>
    <tr><td colspan="2"><p>{FUNCT}: {DESCRIPTION}</p></td></tr>
    <tr><td width="15%">&nbsp;Return</td><td width="85%">&nbsp;{RETURN_DOC}</td></tr>
    <tr><td>&nbsp;Parameters</td><td>'''

    html_function_param = '&nbsp;{PARAM}: {PARAM_DOC}'

    html_function_close = '</td></tr></tbody></table>'

    html_footer = '<hr/><p style="text-align: center;">Generated by strdl v0.1</p>'
